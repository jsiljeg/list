...
export const STYLE_ORDER = {
  ...
  champagne: ["aperitif", "oysters", "caviar", "seafood", "shellfish", "white_fish",
    "light_starters", "sushi", "poultry", "white_meat", "charcuterie", "cheese_fresh", "cheese_hard", "foie_gras"],
  ...
  champagne_prestige: ["caviar", "oysters", "shellfish", "white_fish", "poultry", "veal",
    "white_meat", "cheese_fresh", "charcuterie", "cheese_hard", "solo", "light_starters", "foie_gras"],
