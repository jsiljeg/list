...
const VESSEL_BY_CLASS = {
  ...
  tequila_blanco: "tulip", tequila_reposado: "tulip", tequila_anejo: "tulip",
  mezcal_joven: "tulip",
...
hr: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, 2 do 12 mjeseci u drvu",
    tequila_anejo: "Tequila · añejo, 1 do 3 godine u drvu",
  ...
  bases: {
    ...
    rice: "riža", ume: "ume, japanska marelica",
  ...
  serves: {
    ...
    freezer: "iz zamrzivača", with_tonic: "s tonikom", with_soda: "s gaziranom vodom",
  ...
  aromas: {
    ...
    umeboshi: "umeboshi · slano-kisela ume", koji: "koji", steamed_rice: "kuhana riža",
...
en: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, 2 to 12 months in oak",
    tequila_anejo: "Tequila · añejo, 1 to 3 years in oak",
  ...
  bases: {
    ...
    rice: "rice", ume: "ume, the Japanese apricot",
  ...
  serves: {
    ...
    freezer: "from the freezer", with_tonic: "with tonic", with_soda: "with soda water",
  ...
  aromas: {
    ...
    umeboshi: "umeboshi · salted sour ume", koji: "koji", steamed_rice: "steamed rice",
...
it: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, da 2 a 12 mesi in legno",
    tequila_anejo: "Tequila · añejo, da 1 a 3 anni in legno",
  ...
  bases: {
    ...
    rice: "riso", ume: "ume, albicocca giapponese",
  ...
  serves: {
    ...
    freezer: "dal congelatore", with_tonic: "con tonica", with_soda: "con acqua di soda",
  ...
  aromas: {
    ...
    umeboshi: "umeboshi · ume salata e acida", koji: "koji", steamed_rice: "riso cotto a vapore",
...
fr: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, 2 à 12 mois en fût",
    tequila_anejo: "Tequila · añejo, 1 à 3 ans en fût",
  ...
  bases: {
    ...
    rice: "riz", ume: "ume, abricot du Japon",
  ...
  serves: {
    ...
    freezer: "sorti du congélateur", with_tonic: "avec du tonic", with_soda: "allongé à l'eau gazeuse",
  ...
  aromas: {
    ...
    umeboshi: "umeboshi · ume salé et acide", koji: "koji", steamed_rice: "riz vapeur",
...
de: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · Reposado, 2 bis 12 Monate im Holz",
    tequila_anejo: "Tequila · Añejo, 1 bis 3 Jahre im Holz",
  ...
  bases: {
    ...
    rice: "Reis", ume: "Ume, japanische Aprikose",
  ...
  serves: {
    ...
    freezer: "aus dem Gefrierfach", with_tonic: "mit Tonic", with_soda: "mit Sodawasser",
  ...
  aromas: {
    ...
    umeboshi: "Umeboshi · gesalzene saure Ume", koji: "Koji", steamed_rice: "gedämpfter Reis",
...
zh: {
  ...
  classes: {
    ...
    tequila_reposado: "龙舌兰 · reposado，桶陈 2 至 12 个月",
    tequila_anejo: "龙舌兰 · añejo，桶陈 1 至 3 年",
  ...
  serves: {
    ...
    freezer: "从冷冻室取出", with_tonic: "加汤力水", with_soda: "兑苏打水",
  ...
  aromas: {
    ...
    umeboshi: "梅干（咸酸青梅）", koji: "曲", steamed_rice: "蒸米",
...
sl: {
  ...
  classes: {
    ...
    tequila_reposado: "Tekila · reposado, 2 do 12 mesecev v lesu",
    tequila_anejo: "Tekila · añejo, 1 do 3 leta v lesu",
  ...
  bases: {
    ...
    rice: "riž", ume: "ume, japonska marelica",
  ...
  serves: {
    ...
    freezer: "iz zamrzovalnika", with_tonic: "s tonikom", with_soda: "z gazirano vodo",
  ...
  aromas: {
    ...
    umeboshi: "umeboshi · slano-kisla ume", koji: "koji", steamed_rice: "kuhan riž",
...
es: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, de 2 a 12 meses en madera",
    tequila_anejo: "Tequila · añejo, de 1 a 3 años en madera",
  ...
  bases: {
    ...
    rice: "arroz", ume: "ume, albaricoque japonés",
  ...
  serves: {
    ...
    freezer: "del congelador", with_tonic: "con tónica", with_soda: "con soda",
  ...
  aromas: {
    ...
    umeboshi: "umeboshi · ume salado y ácido", koji: "koji", steamed_rice: "arroz al vapor",
