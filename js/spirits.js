...
hr: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, odležana u drvu",
    tequila_anejo: "Tequila · añejo, dulje odležana",
...
en: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, rested in oak",
    tequila_anejo: "Tequila · añejo, longer in oak",
...
it: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, riposata in legno",
    tequila_anejo: "Tequila · añejo, invecchiata più a lungo",
...
fr: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, reposée en fût",
    tequila_anejo: "Tequila · añejo, élevage plus long",
...
de: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · Reposado, im Holz gereift",
    tequila_anejo: "Tequila · Añejo, länger im Holz",
...
zh: {
  ...
  classes: {
    ...
    tequila_reposado: "龙舌兰 · reposado，桶中小憩",
    tequila_anejo: "龙舌兰 · añejo，久陈于桶",
...
sl: {
  ...
  classes: {
    ...
    tequila_reposado: "Tekila · reposado, zorena v lesu",
    tequila_anejo: "Tekila · añejo, dlje zorena",
...
es: {
  ...
  classes: {
    ...
    tequila_reposado: "Tequila · reposado, criada en madera",
    tequila_anejo: "Tequila · añejo, crianza más larga",
