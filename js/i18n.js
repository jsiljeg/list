...
hr: {
  ui: {
    ...
    showWaiter: "Pokažite konobaru",
    waiterHint: "Ovo vino želim naručiti — pokažite konobaru",
...
en: {
  ui: {
    ...
    showWaiter: "Show your waiter",
    waiterHint: "I would like to order this wine — show your waiter",
...
it: {
  ui: {
    ...
    waiterHint: "Vorrei ordinare questo vino — lo mostri al cameriere",
...
fr: {
  ui: {
    ...
    showWaiter: "Montrez au serveur",
    waiterHint: "Je voudrais commander ce vin — montrez-le au serveur",
...
de: {
  ui: {
    ...
    waiterHint: "Diesen Wein möchte ich bestellen — dem Kellner zeigen",
...
sl: {
  "ui": {
    ...
    "showWaiter": "Pokažite natakarju",
    "waiterHint": "To vino bi rad naročil — pokažite natakarju",
...
es: {
  "ui": {
    ...
    "showWaiter": "Muestre al camarero",
    "waiterHint": "Quisiera pedir este vino — muéstrelo al camarero",
