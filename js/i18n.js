...
hr: {
  ui: {
    ...
    showWaiter: "Pokaži konobaru",
    waiterHint: "Pokažite ovaj zaslon konobaru",
...
en: {
  ui: {
    ...
    waiterHint: "Show this screen to your waiter",
...
it: {
  ui: {
    ...
    waiterHint: "Mostri questo schermo al cameriere",
...
fr: {
  ui: {
    ...
    waiterHint: "Montrez cet écran au serveur",
...
de: {
  ui: {
    ...
    waiterHint: "Zeigen Sie diesen Bildschirm dem Kellner",
...
sl: {
  "ui": {
    ...
    "showWaiter": "Pokaži natakarju",
    "waiterHint": "Pokažite ta zaslon natakarju",
...
es: {
  "ui": {
    ...
    "waiterHint": "Muestre esta pantalla al camarero",
